...
export default function TrackLandingScreen({ onSelect }: TrackLandingScreenProps) {
  ...
  return (
    <div className="relative h-screen w-full overflow-y-auto bg-gradient-to-b from-stone-50 via-white to-stone-100 flex flex-col">
      <div className="absolute top-4 right-4 z-10 md:top-6 md:right-6">
        <a
          href="https://github.com/markpukete-web/trackview-3d"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-full border border-stone-200/90 bg-white/90 px-3.5 py-1.5 text-xs font-semibold text-stone-700 shadow-sm backdrop-blur-md transition hover:border-stone-300 hover:bg-stone-50 hover:text-stone-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-400 focus-visible:ring-offset-2 motion-reduce:transition-none"
        >
          <GithubIcon className="h-4 w-4 text-stone-800" />
          <span>GitHub</span>
        </a>
      </div>
