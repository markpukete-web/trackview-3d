...
export default function WeatherBadge({ weather, isLoading, onClick }: WeatherBadgeProps) {
  ...
  return (
    <button
      ...
      className="absolute top-3 right-3 md:right-[378px] bg-black/60 backdrop-blur-sm rounded-lg px-3 py-2 flex items-center gap-2 hover:bg-black/70 transition-colors duration-150 cursor-pointer z-20"
    >
