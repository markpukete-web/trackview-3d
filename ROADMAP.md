...
| 4 (started) | Doomben track — 19 POIs (incl. the railway station) and a first-visit guided tour, with transport and accessibility info, plus a railway station → Gate 5 walking route |
...
| Doomben walking routes | Small | The railway station → Gate 5 arrival route is in. Still to trace accurately on the 3D tiles (in-app `Shift+W` capture): Gate 4 → Public Grandstand, Gate 4 → Mounting Yard, and the infield car park → grandstand tunnel crossing |
